...
--
-- Servidor: localhost
-- Tiempo de generaci�n: 09-02-2009 a las 13:48:18
...
CREATE TABLE IF NOT EXISTS cliente (
  ...
  Titulo enum('Sr. D.','Sra. D�.','Sres. de') collate utf8_unicode_ci NOT NULL,
  Observaciones text collate utf8_unicode_ci,
...
CREATE TABLE IF NOT EXISTS venta (
  ...
  FormaPago enum('Visa','Efectivo','Transferencia','Tal�n') collate utf8_unicode_ci default NULL,
  Observaciones text collate utf8_unicode_ci,
